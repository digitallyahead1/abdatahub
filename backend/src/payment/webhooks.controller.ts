...
export class WebhooksController {
  ...
  async handleMonnifyWebhook(@Req() req: RawBodyRequest<any>, @Body() body: any) {
    console.log('=== MONNIFY WEBHOOK RECEIVED ===');
    console.log('Headers:', JSON.stringify({
      'monnify-signature': req.headers['monnify-signature'],
    ...
    try {
      ...
      console.error('Failed to log monnify webhook to audit_log:', logErr);
    }
